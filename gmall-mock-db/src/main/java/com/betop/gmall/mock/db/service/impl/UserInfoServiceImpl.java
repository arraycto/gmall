...
import com.betop.gmall.common.util.*;
import com.betop.gmall.mock.db.bean.UserInfo;
import com.betop.gmall.mock.db.mapper.UserInfoMapper;
import com.betop.gmall.mock.db.service.UserInfoService;
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
    ...
    public void  genUserInfos( Boolean ifClear){
        ...
        Integer count = checkCount(userCountString);
    ...
    public UserInfo initUserInfo(Date date){
        Integer maleRateWeight = checkRatioNum(this.maleRate);
    ...
    public void  updateUsers(Date date){
        ...
        Integer updateRateWeight = checkRatioNum(this.updateRate);
