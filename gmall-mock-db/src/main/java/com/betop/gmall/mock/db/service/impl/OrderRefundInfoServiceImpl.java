...
import com.betop.gmall.mock.db.bean.RefundPayment;
import com.betop.gmall.mock.db.constant.GmallConstant;
import com.betop.gmall.mock.db.mapper.OrderRefundInfoMapper;
import com.betop.gmall.mock.db.service.OrderInfoService;
import com.betop.gmall.mock.db.service.OrderRefundInfoService;
import com.betop.gmall.mock.db.service.OrderStatusLogService;
import com.betop.gmall.mock.db.service.RefundPaymentService;
...
import static com.betop.gmall.common.util.ParamUtil.*;
...
public class OrderRefundInfoServiceImpl extends ServiceImpl<OrderRefundInfoMapper, OrderRefundInfo> implements OrderRefundInfoService {
    ...
    public void  genRefundsOrFinish(Boolean ifClear){
        ...
        Date date = checkDate(mockDate);
        Integer ifRefundRateWeight = checkRatioNum(this.ifRefundRate);
        ...
        Integer[] refundReasonRateArr = checkRate(this.refundReasonRate,7);
